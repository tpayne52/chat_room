...
app = Flask(__name__)
app.config["SECRET_KEY"] = "ndbiuG87Bu7"
...
def connect(auth):
    ...
    socketio.emit("userJoin", {"chatters": rooms[room]["members"], "name": name}, to=room)
...
def disconnect():
    ...
    if room in rooms:
        ...
        if rooms[room]["members"] <= 0:
            ...
            socketio.emit("userLeave", {"chatters": rooms[room]["members"], "name": name}, to=room)
